...
GROK_TOKEN = SecretStr(os.getenv("GROK_TOKEN"))  # type: ignore
...
def llm_instance():
    return LLM(
        ...
        api_key=GROK_TOKEN.get_secret_value(),
    )
...
def test_grok_chat_completion_sync(llm_instance, test_messages):
...
def test_grok_chat_completion_sync_streaming(llm_instance, test_messages):
    """Test streaming chat completion with MistralAI."""
...
@pytest.mark.asyncio
async def test_grok_chat_completion_async(llm_instance, test_messages):
...
@pytest.mark.asyncio
async def test_grok_chat_completion_async_streaming(llm_instance, test_messages):
    """Test asynchronous chat completion with MistralAI."""
